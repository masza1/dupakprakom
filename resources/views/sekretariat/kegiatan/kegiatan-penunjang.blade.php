...
@push('js')
    <script>
        $(document).ready(function() {
            var initial = {}
            var datatableURL = '{{ route('sekretariat.pen-activities.index') }}'
            var datatable;
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                ...
                                html += `<button class="btn btn-danger btn-sm text-white mx-1" data-coreui-target="#modalDelete" data-coreui-toggle="modal" data-id="${data.id}" data-url="{!! route('sekretariat.pen-activities.destroy', ['id' => ' ']) !!}" ><i class="fa fa-trash"></i></button>`;
                                return html;
                            }
                        }
                    ],
            ...
            $('#modalAddKegiatan').on('show.coreui.modal', function(e) {
                ...
                if (btn.attr('data-id') != undefined) {
                    ...
                    url = '{{ route('sekretariat.pen-activities.update', ['id' => ' ']) }}'
                    ...
                    url = '{!! route('sekretariat.pen-activities.store') !!}'
